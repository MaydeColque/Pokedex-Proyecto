...
namespace Pokemons
{
    public partial class FormPrimeraApp : Form
    {
        ...
        private void btnPokedexWeb_Click(object sender, EventArgs e)
        {
            ...
            {
                itemSeleccionadoDGV();
                string nombre = pokeSeleccionado.Nombre;
                string Url = $"https://www.pokemon.com/es/pokedex/{nombre}";
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            List<Pokemon> listaBusqueda = pokemons.FindAll(p => p.Nombre.ToLower().Contains(textoBuscado.ToLower()) && p.Activo != 0);
            if (listaBusqueda.Count > 0)
            {
                ...
                MessageBox.Show("No se han encontrado coincidencias. TIP: Verifique los datos ingresados.", "Sin Resultados...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
