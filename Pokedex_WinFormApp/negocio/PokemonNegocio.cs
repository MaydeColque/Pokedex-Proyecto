...
namespace Pokemons
{
		...
		//Lo dejo así, a modo de recordar como empezamos a aprenderlo.
    {
        ...
        public void modificar(Pokemon pokemonAModificar)
        {
            ...
            try
            {
                datos.cambiarConsulta("update POKEMONS set Numero = @numero, Descripcion = @descripicion, UrlImagen = @urlImagen, IdTipo = @idTipo, IdDebilidad = @idDebilidad, IdEvolucion = NULL, Activo = 1 where Id = @id");
